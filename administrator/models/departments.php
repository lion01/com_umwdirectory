 ...
 */
class UmwdirectoryModelDepartments extends JModelList {
    ...
    protected function populateState($ordering = null, $direction = null) {
        ...
        parent::populateState('a.department', 'asc');
    }
    ...
    protected function getListQuery() {
        ...
        $query->from('`#__umwdirectory_department` AS a');
    ...
    if (is_numeric($published)) {
        ...
        if (!empty($search)) {
            if (stripos($search, 'id:') === 0) {
                ...
                $query->where('( a.department LIKE '.$search.' )');
            }
        }
